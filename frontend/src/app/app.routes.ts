...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'users', data: { mode: 'users' }, loadComponent: () => import('./features/admin/admin-page').then((module) => module.AdminPage) },
      { path: 'roles', data: { mode: 'roles' }, loadComponent: () => import('./features/admin/admin-page').then((module) => module.AdminPage) },
